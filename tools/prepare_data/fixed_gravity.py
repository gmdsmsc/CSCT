...
def write_positions(positions, idx, output_path):
    pos_path = output_path / f"positions_{idx}.txt"
...
def make(start_pos):
    output_directory = Path("data/fixed_gravity")
    ...
    while running:
        ...
        if len(stored_frames) >= 50:
            ...
            write_positions(positions, idx, output_directory)
...
if __name__ == "__main__":
    print('Generating fixed_gravity data outputs..')
